            ...
            <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div>
                    <Button
                        type="submit"
                        disabled={isLoading}
                        className="w-full bg-[#9B3F47] "> {isLoading ? 'Sending..' : 'Sent'} </Button>
                </div>
            </form>
        </div>
    );
                ...
                <footer className="w-full  flex flex-col justify-between items-center md:items-start gap-5 xl:gap-x-10 lg:flex-row gap-y-10">
                    ...
                    <div className="w-full lg:w-1/4 flex flex-col gap-y-4">
                        <div className="flex flex-col items-center md:items-start text-center md:text-left">
                            ...
                            <p className="py-3">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id, repellat excepturi. Ad alias rem, deserunt incidunt, enim sit consequuntur neque magnam eaque cum cumque officiis et, possimus sint animi repellat!
                            </p>
                        </div>
                    </div>
                    {/* 2 */}
                    ...
                    <div className="flex flex-col justify-end gap-2 w-full md:w-2/4 lg:w-1/4">
                        <p className="text-w-paragraph-regular-20 text-center uppercase md:text-left">Contact us</p>
                        <Newsletter isLoading={false} handleDataSubmit={async () => { }} />
                        <div className="pt-5">
                            <p className="text-w-paragraph-regular-20 whitespace-nowrap text-center md:text-left">Our Every Media</p>
                            <div className="flex justify-center md:justify-start w-[80%] md:w-full mx-auto gap-5 mt-1.5">
                                <Link target="_blank" href="https://wa.me/8801517836043"><WhatsappIcon size="32" /></Link>
                                <Link target="_blank" href="https://join.skype.com/invite/WPctQ2K5fran"><SkypeIcon size="32" /></Link>
                                <Link target="_blank" href="https://www.facebook.com/omnicstudio"><FacebookIcon size="32" /></Link>
                                <Link target="_blank" href="https://linkedin.com/in/omnic-studio-2b68b130b"><LinkedinIcon size="32" /></Link>
                                <Link target="_blank" href="https://www.instagram.com/omnicstudio"><InstagramIcon size="32" /></Link>
