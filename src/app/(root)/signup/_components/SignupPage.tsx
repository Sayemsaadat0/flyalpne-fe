        ...
        <div className='bg-gray-100 max-w-[550px] mx-auto mt-24 rounded-[12px] p-5 md:p-10 space-y-5'>
            ...
            <form className="space-y-6" autoComplete="off" onSubmit={handleSubmit}>
                ...
                <TextInput
                    ...
                    onChange={handleChange}
                    type="password"
                    error={Boolean(errors.confirm_password) && touched.confirm_password && errors.confirm_password}
                />
                {/* Hidden role field */}
                ...
                <div className='w-full flex justify-center'>
                    <Button
                        ...
                        className="w-full bg-f-primary-1-500 text-white">
                        Sign Up
                    </Button>
                </div>
            </form>
            <div className='text-center'>
                Already have an account? <Link className='text-c-violet-700 font-bold' href={'/login'}>Sign in</Link>
            </div>
        </div>
    );
};
