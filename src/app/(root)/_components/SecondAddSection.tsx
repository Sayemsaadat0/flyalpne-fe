  ...
  return (
    <div className='flex  flex-col md:flex-row items-center justify-center p-5 w-full bg-f-primary-1-50 rounded-[20px]'>
      ...
      <div className='w-full border space-y-10'>
        <h3 className='text-w-header-1-bold-22  md:text-w-header-4-bold-56'>Are You Missing Anything? <span className='text-f-primary-1-600'>Explore</span> Travel Must-Haves!</h3>
