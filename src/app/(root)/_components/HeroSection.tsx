...
const BigFeaturedSection = () => {
  ...
  return (
    <div className="px-0 rounded-[20px] ">
                    ...
                    <div className="absolute z-20 top-1/2 left-1/2 md:left-96 lg:left-80 xl:left-96 lg:w-[70%] xl:w-[60%] -translate-x-1/2 -translate-y-1/2">
                      ...
                      >
                        <div className="space-y-2">
                          <h1 className=" text-w-title-1-Medium-22 sm:text-w-header-3-bold-42 md:text-w-header-4-bold-56 md:leading-[60px] lg:leading-[48px] leading-8 xl:text-w-header-4-bold-56 xl:leading-[60px] text-center lg:text-left">
                            Which one <span className="text-f-primary-1">headphone</span> must you
                            buy?
                          </h1>
                        </div>
