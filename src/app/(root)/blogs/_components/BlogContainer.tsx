...
const featuredPost = {
    ...
    excerpt: "Discover the latest trends and must-have items for your summer wardrobe. From breezy dresses to stylish accessories, we've got you covered.",
    image: "https://jadeblue.com/cdn/shop/articles/mens_summer_wear.jpg?v=1714380887&width=1100?height=400&width=800",
    date: "June 15, 2023",
    author: "Emma Style",
...
const recentPosts = [
    ...
    },
    {
        ...
        image: "https://www.shopatorient.com/cdn/shop/articles/Winter_Clearance_Desktop_2.jpg?v=1735626047&width=1100",
        date: "June 5, 2023",
        author: "Olivia Green",
                                ...
                                <div className="relative">
                                    <div className="sm:text-center">
                                        ...
                                        <p className="mt-6 mx-auto max-w-2xl text-lg text-rose-100">
                                            Stay up to date with the latest trends, tips, and exclusive offers by subscribing to our newsletter.
                                        </p>
                                    </div>
                                    <NewsletterSignup />
                                </div>
