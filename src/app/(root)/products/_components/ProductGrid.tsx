                ...
                >
                    ...
                    <div className="space-y-2">
                        <div className="opacity-0 group-hover:opacity-100 transition-opacity">
                            {product.category && (
                                <p className="text-white text-sm mb-4">{product.category}</p>
                            )}
                            <div className="flex items-center gap-4">
                                <button
                                    className="h-8 px-4 flex-1 flex justify-center items-center rounded-full font-bold gap-2 shadow-lg text-gray-600 bg-white  hover:bg-white/90"
                                >
                                    <ShoppingCart />
                                    Buy
                                </button>
                                ...
                                <button
                                    className=" bg-[rgba(255,255,255,0.21)] h-8 w-8 rounded-full flex justify-center items-center  hover:bg-white/90"
                                >
