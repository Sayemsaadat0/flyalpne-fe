...
const ProductFilters = () => {
    return (
        <div className="md:w-[280px]  bg-white p-4 md:border rounded-lg font-semibold">
            {/* Categories Section */}
            <Accordion type="multiple" collapsible="true" defaultValue={['categories', 'price', 'brand', 'color']}>
                {/* Categories Section */}
                <AccordionItem value="categories">
                    <div className="flex items-center justify-between">
                        <AccordionTrigger className="text-sm font-bold text-[#227989]">CATEGORIES</AccordionTrigger>
