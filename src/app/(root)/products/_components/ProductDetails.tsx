      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-5 space-y-6">
          ...
          <p className="text-gray-600">
            Smartphone Integration - Supports Apple CarPlay and Android Auto, enabling seamless
            integration with your smartphone. Safely access your favorites.
          </p>
            ...
            <div className="flex gap-4 text-sm text-gray-600">
              ...
              <button className="flex items-center gap-2">
                <svg className="h-4 w-4" viewBox="0 0 24 24">
                  <path
                    fill="currentColor"
                    d="M17,13V11H7V13H17M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z"
                  />
                </svg>
                Add to Compare
              </button>
      ...
      <div className="space-y-10">
        <div className="space-x-5">
          <Button
            size={'sm'}
            label="Additional"
            variant={activeTab === 'additional' ? 'primarybtn' : 'outlineBtn'}
            onClick={() => setActiveTab('additional')}
          />
          <Button
            size={'sm'}
            label="Settings"
            variant={activeTab === 'settings' ? 'primarybtn' : 'outlineBtn'}
            onClick={() => setActiveTab('settings')}
          />
          <Button
            size={'sm'}
            label="Profile"
            variant={activeTab === 'profile' ? 'primarybtn' : 'outlineBtn'}
