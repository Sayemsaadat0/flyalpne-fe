      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-1">
            {[1, 2, 3, 4, 5].map((rating) => (
              <Star
                key={rating}
                className={`w-5 h-5 ${
                  rating <= 4 ? 'fill-yellow-400 text-yellow-400' : 'text-gray-300'
                }`}
              />
            ))}
          </div>
          ...
          <p className="text-sm text-gray-600">
            Book now at ₹10,500 and pay the remaining deposit with your first rent payment. Valid
            until next usage of ₹1500/Cashback.
          </p>
          ...
          <div className="flex gap-4">
            ...
            <Button className="flex-1 bg-[#FE6F4E] text-white hover:bg-pink-600">Rent Now</Button>
          </div>
        </div>
      </div>
    </div>
